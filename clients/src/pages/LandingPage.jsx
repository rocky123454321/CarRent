        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="mt-10">
            <button className="bg-gradient-to-r from-blue-600 to-blue-700
             text-white px-8 py-3 lg:px-8 lg:py-4 text-lg lg:text-x2 font-black rounded-3xl shadow-2xl hover:shadow-3xl hover:from-blue-700 hover:to-blue-800 transform hover:-translate-y-1 
            transition-all duration-300 border-0 tracking-wide uppercase">
              See All Cars
            </button>
          </div>
        </div>
