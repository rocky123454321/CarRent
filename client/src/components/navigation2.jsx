      ...
      <div className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          {!user ? (
            ...
            <>
              ...
              <div className="relative">
                ...
                {profileOpen && (
                  <div className="absolute right-0 mt-3 w-64 bg-white border border-gray-200 rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="md:hidden">
          <button onClick={() => setMobileOpen(!mobileOpen)}>
            {!mobileOpen ? <Menu size={24} className="z-10"/> : <X size={24} className="z-10"/>}
          </button>
        </div>
      </div>
