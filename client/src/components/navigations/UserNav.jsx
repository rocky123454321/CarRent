...
const NotifIcon = ({ type, status }) => {
  if (type === "chat")
    return (
      <div className="w-9 h-9 rounded-full bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 flex items-center justify-center shrink-0 text-[10px] font-black">
...
const NotifRow = ({ n, onView }) => {
  ...
  const sub =
    n.type === "chat"
      ? n.message
      : `${n.carBrand} ${n.carModel} — status updated to ${n.status}`;
...
const UserNav = () => {
  ...
  const {
    ...
    markAllRead, markNotificationRead,
            ...
            >
              ...
              <DropdownMenuGroup className="p-1.5">
                <DropdownMenuItem
                  ...
                  className="rounded-lg py-2.5 px-4 cursor-pointer text-[10px] font-bold uppercase tracking-widest text-zinc-500 focus:text-zinc-900 dark:focus:text-white focus:bg-zinc-50 dark:focus:bg-zinc-900 flex items-center gap-3"
                >
        ...
        <AlertDialogContent className="max-w-[calc(100%-2rem)] w-full rounded-2xl p-0 border border-zinc-100 dark:border-zinc-900 bg-white dark:bg-zinc-950 overflow-hidden shadow-2xl">
          <AlertDialogHeader className="px-6 py-5 border-b border-zinc-50 dark:border-zinc-900">
            <div className="flex items-center justify-between">
              <AlertDialogTitle className="text-[10px] font-black uppercase tracking-widest text-zinc-400">
                Notifications
              </AlertDialogTitle>
