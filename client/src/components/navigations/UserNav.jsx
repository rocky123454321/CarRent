...
const UserNav = () => {
  ...
  return (
    <nav className="bg-white/90 dark:bg-slate-900 backdrop-blur-md w-full fixed top-0 left-0 z-50 border-b border-slate-200/60 dark:border-slate-800 shadow-sm transition-colors">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden lg:flex relative w-[160px] xl:w-[240px]">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 rounded-xl bg-slate-50 dark:bg-slate-950 border border-transparent dark:border-slate-800 focus:bg-white dark:focus:bg-slate-900 focus:border-blue-500 outline-none text-sm dark:text-slate-200 transition-all"
            />
          </div>
          ...
          <div className="hidden sm:block">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="relative w-10 h-10 flex items-center justify-center rounded-xl border border-slate-200 dark:border-slate-800 text-slate-500 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all">
                  <Bell size={18} />
                  {totalUnread > 0 && (
              ...
              <DropdownMenuContent className="w-80 rounded-2xl shadow-xl border-slate-200 dark:border-slate-800 p-0 mt-2 bg-white dark:bg-slate-900" align="end">
                <div className="px-4 py-3 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between bg-slate-50/50 dark:bg-slate-800/50 rounded-t-2xl">
          ...
          <div className="hidden sm:block">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-2 p-1 pr-2 lg:pr-3 rounded-xl border border-slate-200 dark:border-slate-800 hover:border-blue-200 dark:hover:border-blue-900 hover:bg-blue-50/30 dark:hover:bg-blue-900/20 transition-all">
              ...
              <DropdownMenuContent className="w-64 rounded-2xl shadow-xl border-slate-200 dark:border-slate-800 p-0 mt-2 overflow-hidden bg-white dark:bg-slate-900" align="end">
                <DropdownMenuLabel className="px-4 py-4 bg-slate-50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-800 font-normal">
          ...
          <div className="md:hidden absolute inset-x-0 top-full bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 shadow-2xl z-50 animate-in slide-in-from-top duration-300 ease-out">
            <div className="p-5 flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button onClick={() => handleMobileNav('/cars')} className="flex flex-col items-center justify-center p-4 rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-950 gap-2 shadow-sm">
                  <div className="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-900 flex items-center justify-center text-slate-600 dark:text-slate-400"><Search size={20} /></div>
                  <span className="text-xs font-bold text-slate-700 dark:text-slate-300">Category</span>
                </button>
                <button onClick={() => handleMobileNav('/my-rentals')} className="flex flex-col items-center justify-center p-4 rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-950 gap-2 shadow-sm">
                  <div className="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-900 flex items-center justify-center text-slate-600 dark:text-slate-400"><CarFront size={20} /></div>
                  <span className="text-xs font-bold text-slate-700 dark:text-slate-300">Rentals</span>
                </button>
              </div>

              <div className="flex flex-col gap-2">
                <button onClick={() => { setNotifOpen(true); setMobileOpen(false); }} className="flex items-center justify-between p-4 rounded-2xl bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-800 shadow-sm">
                ...
                <button onClick={() => handleMobileNav('/chat')} className="flex items-center justify-between p-4 rounded-2xl bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-800 shadow-sm">
                  <div className="flex items-center gap-3">
      ...
      <AlertDialog open={notifOpen} onOpenChange={setNotifOpen}>
        <AlertDialogContent className="max-w-[calc(100%-2rem)] w-full rounded-3xl p-0 overflow-hidden border-none shadow-2xl bg-white dark:bg-slate-900">
          <AlertDialogHeader className="px-5 py-4 border-b border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900">
