...
// ── Sidebar ── defined OUTSIDE AdminChatPage
const Sidebar = ({
...
// ── Chat ── defined OUTSIDE AdminChatPage
const Chat = ({
    ...
    <div className="px-4 py-3.5 border-b border-slate-100 flex items-center gap-3 shrink-0 bg-white">
      ...
      {activeConversation ? (
        <>
          ...
          <div className="flex-1 min-w-0">
            <p className="font-bold text-slate-900 text-sm truncate">{getDisplayName(activeConversation)}</p>
            <div className="flex items-center gap-1.5 mt-0.5">
              <span className={`w-1.5 h-1.5 rounded-full ${onlineUsers.includes(activeConversation) ? 'bg-emerald-500' : 'bg-slate-300'}`} />
    ...
    <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 bg-slate-50/30">
      {!activeConversation ? (
        <div className="flex flex-col items-center justify-center h-full text-slate-300 text-center px-6">
          <Sparkles size={36} className="mb-3 text-indigo-200" />
        ...
        <div className="flex flex-col items-center justify-center h-full text-center px-6">
          <div className="bg-white border border-slate-100 rounded-2xl p-7 shadow-sm max-w-[260px]">
            <Inbox size={28} className="mx-auto mb-3 text-indigo-200" />
...
const AdminChatPage = () => {
  ...
  return (
    <div className="flex flex-col gap-4" style={font}>
      <div>
        <p className="text-indigo-600 font-semibold text-xs tracking-widest uppercase mb-0.5">Support</p>
