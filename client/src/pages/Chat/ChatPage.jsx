...
import { useChatPageStore } from '../../store/ChatPageStore.js';
import { useAuthStore } from '../../store/authStore.js';
import { useLocation, useNavigate } from 'react-router-dom';
import { Send, Wifi, WifiOff, ShieldCheck, Car, ArrowLeft } from 'lucide-react';
      ...
      <div className="flex h-[calc(100vh-80px)] bg-gray-50 rounded-2xl overflow-hidden border border-gray-100 shadow-sm">
        ...
        <div className="w-72 bg-white border-r border-gray-100 flex flex-col shrink-0">
          ...
          <div className="flex-1 overflow-y-auto">
            {!adminId ? (
              <p className="text-center text-gray-400 text-xs py-12 px-4">No admin available.</p>
            ) : (
              <button
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-blue-700">{adminName}</p>
