          ...
          <form onSubmit={handleLogin} className="px-10 pb-10 space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between ml-1">
                ...
                <Link to="/forgot-password" title="reset" className="text-[10px] text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors uppercase tracking-widest font-bold">
                  Forgot?
                </Link>
              </div>
              <div className="relative group">
            ...
            <p className="text-center pt-2">
              <span className="text-[11px] text-zinc-400 uppercase tracking-widest font-medium">No account? </span>
              <Link to="/signup" className="text-[11px] text-zinc-900 dark:text-white font-bold uppercase tracking-[0.2em] hover:opacity-70 transition-opacity">
                Create one
              </Link>
            </p>
